...
\begin{figure}[tb]
    ...
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \includegraphics[scale=0.45]{figuras/Opc_endpoint.png}
    ...
    \begin{minipage}[t]{0.45\textwidth}
        \centering
        \includegraphics[scale=0.45]{figuras/certificados_opc.png}
...
\begin{figure}[tb]
    ...
    \begin{minipage}[t]{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figuras/celda_linea_2.png}
    ...
    \begin{minipage}[t]{0.3\textwidth}
        \centering
        \includegraphics[width=\textwidth]{figuras/celda_linea_3.png}
        \caption{Interruptor en tránsito o con discrepancia.}
