...
\begin{figure}[t]
    \centering
    % Sustituye el nombre del archivo por el de tu captura real
    \includegraphics[width=0.85\textwidth]{figuras/WTG_Faceplate.png}
...
\begin{figure}[t]
    \centering
    % Sustituye el nombre del archivo por el de tu captura real
    \includegraphics[width=0.85\textwidth]{figuras/Park_Faceplate.png}
