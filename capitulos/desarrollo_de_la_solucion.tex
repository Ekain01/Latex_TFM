...
\begin{itemize}
    \item Capa de Adquisición y Emisión (Edge): Encargada de la recopilación de datos en tiempo real desde los aerogeneradores y su publicación en la nube mediante protocolos de mensajería ligera como MQTT mediante WinCC Cloud Connector.
    \item Capa de Infraestructura (Cloud): Proporciona el entorno computacional necesario para el despliegue de los servicios en la nube, garantizando alta disponibilidad y escalabilidad.
    \item Capa de Ingesta y Procesamiento Intermedio: Responsable de la suscripción a los datos publicados, su filtrado, normalización y transformación antes de su almacenamiento.
    \item Capa de Almacenamiento (TSDB): Optimizada para el almacenamiento eficiente de datos de series temporales, permitiendo consultas rápidas y eficientes sobre grandes volúmenes de datos
    \item Capa de Visualización e Inteligencia de Negocio: Permite la construcción de dashboards interactivos para la monitorización del rendimiento del parque eólico y la toma de decisiones informada basada en los datos históricos y en tiempo real.
\end{itemize}
