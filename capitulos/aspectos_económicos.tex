...
El cálculo de horas (850 horas en total) refleja el volumen de dedicación requerido para un proyecto de esta envergadura \ref{sec:presupuesto_mano_obra}.
...
\midrule
Ingeniero (Nivel 1) & 850 & 12.00 & 10.200,00 \\
Director de TFM & 20 & 16.00 & 320,00 \\
\midrule
\textbf{Total Mano de Obra} & \textbf{870} & & \textbf{10.520,00} \\
\bottomrule
\end{tabular}
}
\end{table}
...
La agregación de los costes de ingeniería, las licencias de software, la amortización de infraestructura local y el coste estimado de la infraestructura en AWS arroja la base imponible del proyecto (ver Tabla \ref{tab:presupuesto_total}).
...
\midrule
Costes de Ingeniería (Mano de obra) & 10.520,00 \\
Costes de Software e Infraestructura & 19.650,00 \\
Coste estimado infraestructura AWS & 19,87 \\
\midrule
\textbf{Presupuesto Total General} & \textbf{30.189,87} \\
\bottomrule
\end{tabular}
\end{table}
