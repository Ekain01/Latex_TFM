...
\begin{figure}[tb]
    ...
    \caption{Evolucion de las falsas alarmas (naranja) en un parque eolico agrupando los aerogeneradores en grupos de condiciones (k-means) en lugar de por proximidad física.}
    \label{fig:ml}
\end{figure}
