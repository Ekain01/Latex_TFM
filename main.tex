...
%--- Insertar la portada
\includepdf[pages=-]{Portada2.pdf} % Se recomienda modificar en word y subir el pdf 

%---

%--- Implementar las partes principales del TFM
\pagestyle{plain}
\input{parte-frontal/resumen}
\input{parte-frontal/indice}
\input{parte-frontal/lista_de_tablas_ilustraciones}
\renewcommand{\figurename}{Figura}
\input{parte-frontal/acronimos_lista}	
...
\input{capitulos/beneficios}
\input{capitulos/estado_del_arte}
\input{capitulos/alternativas}
\input{capitulos/desarrollo_de_la_solucion}
\input{capitulos/analisis_de_resultados}
\input{capitulos/metodología}
\input{capitulos/aspectos_económicos}
...
\input{anexos/Anexo_4}
\input{anexos/Anexo_5}
\newpage
\mbox{}
